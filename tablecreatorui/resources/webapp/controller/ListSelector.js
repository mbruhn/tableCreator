sap.ui.define([
		...
		return BaseObject.extend("creator.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias creator.model.ListSelector
			 */
			 ...
			 * @return {creator.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
