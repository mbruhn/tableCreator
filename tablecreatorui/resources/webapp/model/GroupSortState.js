sap.ui.define([
	...
	return BaseObject.extend("creator.model.GroupSortState", {
		 ...
		 * @alias creator.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "key.tableName");
			}
