sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("creator/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("creator.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["creator/localService/mockserver"], function (mockserver) {
